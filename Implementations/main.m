...
% kappa = 15;
% s = 0.2;
noise_params = [[50,15,0.2], [10, 25, 10]]
for i=1:2
...
write_video(video_noisy, '../Data/bus_cif_noisy', video_info, num_frames);

K = 5;                                              % Number of neighbourhood frames to consider
...
write_video(median_filtered_video, '../Data/bus_cif_median_filtered', video_info, num_frames);
...
write_video(denoised_video, '../Data/bus_cif_coloured_denoised', video_info, num_frames);
fprintf("PSNR of denoised image: %s", PSNR(denoised_video, video, num_frames));
